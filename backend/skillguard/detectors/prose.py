...
PROSE_PATTERNS: list[tuple[str, Capability, Severity, str, str]] = [
    ...
    ("SG-P1", Capability.AGENT_MANIPULATION, Severity.HIGH,
    ...
    ("SG-P2", Capability.AGENT_MANIPULATION, Severity.HIGH,
     r"\bignore\s+(?:all\s+)?(?:previous|prior|above)\s+instructions\b",
     "Classic prompt-injection override phrase."),
    ("SG-P3", Capability.AGENT_MANIPULATION, Severity.HIGH,
    ...
    ("SG-P4", Capability.AGENT_MANIPULATION, Severity.MEDIUM,
    ...
    ("SG-P5", Capability.AGENT_MANIPULATION, Severity.MEDIUM,
    ...
    ("SG-P6", Capability.TASK_THEN_PAYLOAD, Severity.MEDIUM,
    ...
    ("SG-P7", Capability.CREDENTIAL_ACCESS, Severity.HIGH,
    ...
    ("SG-P8", Capability.EXFILTRATION, Severity.HIGH,
    ...
    ("SG-P9", Capability.STAGE2_FETCH, Severity.HIGH,
    ...
    ("SG-P10", Capability.PERSISTENCE, Severity.MEDIUM,
    ...
    ("SG-P11", Capability.ANTI_FORENSICS, Severity.MEDIUM,
    ...
    ("SG-P12", Capability.HIDDEN_EXECUTION, Severity.MEDIUM,
