...
PATTERNS: list[tuple[str, Capability, Severity, str, str]] = [
    ...
    ("SG-E1", Capability.SSRF, Severity.HIGH,
    ...
    ("SG-E5", Capability.HARMFUL_CONTENT, Severity.HIGH,
    ...
    ("SG-E6", Capability.HARMFUL_CONTENT, Severity.MEDIUM,
    ...
    ("SG-E7", Capability.ANTI_REFUSAL, Severity.HIGH,
    ...
    ("SG-E8", Capability.ANTI_REFUSAL, Severity.MEDIUM,
    ...
    ("SG-E9", Capability.AGENT_SNOOPING, Severity.MEDIUM,
    ...
    ("SG-E10", Capability.AGENT_SNOOPING, Severity.MEDIUM,
